        ...
        <table class="table">
            ...
            @foreach($empleado as $empleado)
                <tr>
                    ...
                    <td>{{$empleado->salon}}</td>


                    <td>
                        <button onclick="modulo({{$modulo = $empleado->salon}})" class="btn btn-sm btn-success"
                                title="Editar"
                ...
                <div class="modal-content">
                    ...
                    <form method="post" action="{{route("nuevoEmpleadoBanda")}}" enctype="multipart/form-data">
                        ...
                        <div class="modal-body" style="object-fit: fill">
                            ...
                            <div class="form-group">
                                <label for="modulos">Seleccione El Salon</label>
                                <br>
                                <select name="modulo"
                                        required
                                        style="width: 100%"
                                        class="emp1 form-control @error('id_marca') is-invalid @enderror" id="modulos">
                ...
                <div class="modal-content">
                    ...
                    <form method="post" action="{{route("editarempleadoBanda")}}" >
                        ...
                        <div class="modal-body" style="object-fit: fill">
                            ...
                            <div class="form-group">
                                <label for="modulo">Seleccione El Salon</label>
                                <br>
                                <select name="modulo"
                                        required
                                        style="width: 100%"
                                        class="emp1 form-control @error('id_marca') is-invalid @enderror" id="modulo">
                                    <option disabled selected value="">Seleccione</option>
                                        <option value="1">Modulo #1</option>
                                        <option value="2">Modulo #2</option>
                                        <option value="3">Modulo #3</option>
